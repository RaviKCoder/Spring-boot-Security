...
//		auth.inMemoryAuthentication().withUser("rajesh").password("{noop}vizag").roles("VISITOR");
		...
		auth.inMemoryAuthentication().passwordEncoder(new BCryptPasswordEncoder()).withUser("raja").password("$2a$10$mGdEG0rgYPlvqYm.n./4JuQV4gEQLWc2IvylHyvtvy7fwNyYdY8nC").roles("CUSTOMER");
